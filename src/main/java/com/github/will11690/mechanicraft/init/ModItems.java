...
public class ModItems {
    ...
    public static final RegistryObject<Item> EMERONIUM_SWORD = RegistryHandler.ITEMS.register("emeronium_sword",
            () -> new SwordItem(MechanicraftToolTiers.EMERONIUM, 0, -2.0F,
