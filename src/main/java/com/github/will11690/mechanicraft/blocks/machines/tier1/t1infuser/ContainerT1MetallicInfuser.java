...
public class ContainerT1MetallicInfuser extends Container {
    ...
    public ContainerT1MetallicInfuser(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	...
    	this((TileEntityT1MetallicInfuser) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(5), id, playerInventory, new ItemStackHandler(4));
