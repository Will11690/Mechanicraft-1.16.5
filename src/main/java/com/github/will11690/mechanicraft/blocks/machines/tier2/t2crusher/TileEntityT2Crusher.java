...
public class TileEntityT2Crusher extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
	...
	private int crushingEnergy = 120/*PER TICK*/;
	private int WORK_TIME = 10 * 18;
		
	private static final int capacity = ModConfigs.t2CrusherCapacityInt;
	private static final int receive = ModConfigs.t2CrusherReceiveInt;
