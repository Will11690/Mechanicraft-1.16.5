...
public class ContainerT2SlurryProcessor extends Container {
    ...
    public ContainerT2SlurryProcessor(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	...
    	this((TileEntityT2SlurryProcessor) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(10), id, playerInventory, new ItemStackHandler(3));
