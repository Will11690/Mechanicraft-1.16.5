...
public class ContainerT2MetallicInfuser extends Container {
    ...
    public ContainerT2MetallicInfuser(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	...
    	this((TileEntityT2MetallicInfuser) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(4), id, playerInventory, new ItemStackHandler(5));
