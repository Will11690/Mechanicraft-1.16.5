...
public class ContainerT3OreWasher extends Container {
    ...
    public ContainerT3OreWasher(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	...
    	this((TileEntityT3OreWasher) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(9), id, playerInventory, new ItemStackHandler(3));
	...
	public TileEntityT3OreWasher getTileEntity() {
