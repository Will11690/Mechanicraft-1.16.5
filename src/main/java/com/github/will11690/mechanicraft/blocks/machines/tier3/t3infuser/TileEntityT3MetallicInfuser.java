...
public class TileEntityT3MetallicInfuser extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
	...
	private int infusingEnergy = 140/*PER TICK*/;
	private int WORK_TIME = 10 * 16;
		
	private static final int capacity = ModConfigs.t3InfuserCapacityInt;
	private static final int receive = ModConfigs.t3InfuserReceiveInt;
