...
public class TileEntityT2PoweredSieve extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
	...
	private int sievingEnergy = 120/*PER TICK*/;
	private int WORK_TIME = 10 * 18;
		
	private static final int capacity = ModConfigs.t2PoweredSieveCapacityInt;
	private static final int receive = ModConfigs.t2PoweredSieveReceiveInt;
    ...
    public <T> LazyOptional<T> getCapability(Capability<T> cap, @Nullable Direction side) {
        ...
        if (!this.remove && side != null && cap == CapabilityItemHandler.ITEM_HANDLER_CAPABILITY) {
        	...
        	if(this.level.getBlockState(this.worldPosition).getValue(T2PoweredSieve.FACING) == Direction.NORTH) {
        	...
        	if(this.level.getBlockState(this.worldPosition).getValue(T2PoweredSieve.FACING) == Direction.SOUTH) {
        	...
        	if(this.level.getBlockState(this.worldPosition).getValue(T2PoweredSieve.FACING) == Direction.EAST) {
        	...
        	if(this.level.getBlockState(this.worldPosition).getValue(T2PoweredSieve.FACING) == Direction.WEST) {
