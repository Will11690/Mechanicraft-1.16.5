...
public class TileEntityT5Press extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
	...
	private int pressingEnergy = 180/*PER TICK*/;
	private int WORK_TIME = 10 * 12;
		
	private static final int capacity = ModConfigs.t5PressCapacityInt;
	private static final int receive = ModConfigs.t5PressReceiveInt;
