...
public class TileEntityT6Crusher extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
	...
	private int crushingEnergy = 200/*PER TICK*/;
	private int WORK_TIME = 10 * 10;
		
	private static final int capacity = ModConfigs.t6CrusherCapacityInt;
	private static final int receive = ModConfigs.t6CrusherReceiveInt;
