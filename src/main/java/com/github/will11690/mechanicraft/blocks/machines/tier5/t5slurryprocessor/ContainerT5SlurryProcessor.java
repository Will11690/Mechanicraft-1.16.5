...
public class ContainerT5SlurryProcessor extends Container {
    ...
    public ContainerT5SlurryProcessor(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	...
    	this((TileEntityT5SlurryProcessor) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(11), id, playerInventory, new ItemStackHandler(5));
	...
	public TileEntityT5SlurryProcessor getTileEntity() {
