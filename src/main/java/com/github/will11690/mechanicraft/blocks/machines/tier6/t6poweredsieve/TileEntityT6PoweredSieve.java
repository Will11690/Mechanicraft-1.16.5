...
public class TileEntityT6PoweredSieve extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
	...
	private int sievingEnergy = 200/*PER TICK*/;
	private int WORK_TIME = 10 * 10;
		
	private static final int capacity = ModConfigs.t6PoweredSieveCapacityInt;
	private static final int receive = ModConfigs.t6PoweredSieveReceiveInt;
    ...
    public <T> LazyOptional<T> getCapability(Capability<T> cap, @Nullable Direction side) {
        ...
        if (!this.remove && side != null && cap == CapabilityItemHandler.ITEM_HANDLER_CAPABILITY) {
        	...
        	if(this.level.getBlockState(this.worldPosition).getValue(T6PoweredSieve.FACING) == Direction.NORTH) {
        	...
        	if(this.level.getBlockState(this.worldPosition).getValue(T6PoweredSieve.FACING) == Direction.SOUTH) {
        	...
        	if(this.level.getBlockState(this.worldPosition).getValue(T6PoweredSieve.FACING) == Direction.EAST) {
        	...
        	if(this.level.getBlockState(this.worldPosition).getValue(T6PoweredSieve.FACING) == Direction.WEST) {
