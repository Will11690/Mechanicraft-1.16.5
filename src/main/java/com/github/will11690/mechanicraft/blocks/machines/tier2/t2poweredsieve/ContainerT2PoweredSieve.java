...
public class ContainerT2PoweredSieve extends Container {
    ...
    public ContainerT2PoweredSieve(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	...
    	this((TileEntityT2PoweredSieve) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(5), id, playerInventory, new ItemStackHandler(6));
