...
public class ContainerAdvancedCoalGenerator extends Container {
    ...
    TileEntityAdvancedCoalGenerator tile;
    ...
    public ContainerAdvancedCoalGenerator(@Nullable TileEntityAdvancedCoalGenerator tile, IIntArray fields, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
