...
public class ContainerT3SlurryProcessor extends Container {
    ...
    public ContainerT3SlurryProcessor(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	...
    	this((TileEntityT3SlurryProcessor) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(10), id, playerInventory, new ItemStackHandler(3));
