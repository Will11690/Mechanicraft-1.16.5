...
public class ContainerT3SlurryProcessor extends Container {
    ...
    public ContainerT3SlurryProcessor(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	...
    	this((TileEntityT3SlurryProcessor) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(11), id, playerInventory, new ItemStackHandler(3));
	...
	public TileEntityT3SlurryProcessor getTileEntity() {
