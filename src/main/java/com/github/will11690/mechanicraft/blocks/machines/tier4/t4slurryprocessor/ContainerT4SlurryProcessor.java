...
public class ContainerT4SlurryProcessor extends Container {
    ...
    public ContainerT4SlurryProcessor(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	...
    	this((TileEntityT4SlurryProcessor) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(11), id, playerInventory, new ItemStackHandler(4));
	...
	public TileEntityT4SlurryProcessor getTileEntity() {
