...
public class ContainerT3PoweredSieve extends Container {
    ...
    public ContainerT3PoweredSieve(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	...
    	this((TileEntityT3PoweredSieve) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(5), id, playerInventory, new ItemStackHandler(6));
