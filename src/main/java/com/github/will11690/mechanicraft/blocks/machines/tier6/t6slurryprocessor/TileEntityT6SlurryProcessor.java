...
public class TileEntityT6SlurryProcessor extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
	...
	private int processingEnergy = 200/*PER TICK*/;
	private int WORK_TIME = 10 * 10;
		
	private static final int capacity = ModConfigs.t6SlurryProcessorEnergyCapacityInt;
	private static final int receive = ModConfigs.t6SlurryProcessorReceiveInt;
	private static final int fluid_capacity = ModConfigs.t6SlurryProcessorTankCapacityInt;
	...
	private void applyCapUpgrades(ItemStack stack1, ItemStack stack2, ItemStack stack3, ItemStack stack4) {
		...
		if(capUpgradeCount > 0) {
    		...
    		inputFluidTank1.applyCapacityUpgrades(capUpgradeCount);
    		inputFluidTank2.applyCapacityUpgrades(capUpgradeCount);
