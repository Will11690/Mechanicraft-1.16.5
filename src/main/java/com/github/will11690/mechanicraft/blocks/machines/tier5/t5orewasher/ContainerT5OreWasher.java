...
public class ContainerT5OreWasher extends Container {
    ...
    public ContainerT5OreWasher(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	...
    	this((TileEntityT5OreWasher) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(8), id, playerInventory, new ItemStackHandler(5));
	...
	public TileEntityT5OreWasher getTileEntity() {
