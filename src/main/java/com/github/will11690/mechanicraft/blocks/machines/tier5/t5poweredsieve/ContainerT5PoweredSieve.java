...
public class ContainerT5PoweredSieve extends Container {
    ...
    public ContainerT5PoweredSieve(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	...
    	this((TileEntityT5PoweredSieve) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(4), id, playerInventory, new ItemStackHandler(8));
