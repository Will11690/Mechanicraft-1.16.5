...
public class TileEntityT2EnergyCube extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
    ...
    private void setUpgradeModifiers() {
    	...
    	if(energy.isPresent()) {
    		...
    		energyStorage.oneUpgradeModifier(capacity, transfer, upgradeSlotHandler.getStackInSlot(0));
    ...
    public Container createMenu(int id, PlayerInventory playerInventory, PlayerEntity playerEntity) {
        assert level != null;
        return new ContainerT2EnergyCube(this, this.fields, id, playerInventory, new CombinedInvWrapper(chargeSlotsHandler, upgradeSlotHandler));
    }
