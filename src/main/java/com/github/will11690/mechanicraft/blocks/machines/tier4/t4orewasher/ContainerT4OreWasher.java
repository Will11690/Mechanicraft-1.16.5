...
public class ContainerT4OreWasher extends Container {
    ...
    public ContainerT4OreWasher(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	...
    	this((TileEntityT4OreWasher) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(9), id, playerInventory, new ItemStackHandler(4));
	...
	public TileEntityT4OreWasher getTileEntity() {
