...
public class ContainerT6PoweredSieve extends Container {
    ...
    public ContainerT6PoweredSieve(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	...
    	this((TileEntityT6PoweredSieve) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(4), id, playerInventory, new ItemStackHandler(9));
