...
public class TileEntityT6Press extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
	...
	private int pressingEnergy = 200/*PER TICK*/;
	private int WORK_TIME = 10 * 10;
		
	private static final int capacity = ModConfigs.t6PressCapacityInt;
	private static final int receive = ModConfigs.t6PressReceiveInt;
