...
public class TileEntityT4EnergyCube extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
    ...
    private static final int capacity = ModConfigs.t4EnergyCubeCapacityInt;
    private static final int transfer = ModConfigs.t4EnergyCubeTransferInt;
    ...
    public Container createMenu(int id, PlayerInventory playerInventory, PlayerEntity playerEntity) {
        assert level != null;
        return new ContainerT4EnergyCube(this, this.fields, id, playerInventory, new CombinedInvWrapper(chargeSlotsHandler, upgradeSlotHandler));
    }
