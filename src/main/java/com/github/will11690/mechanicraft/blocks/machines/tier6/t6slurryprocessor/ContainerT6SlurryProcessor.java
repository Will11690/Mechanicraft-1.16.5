...
public class ContainerT6SlurryProcessor extends Container {
    ...
    public ContainerT6SlurryProcessor(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	...
    	this((TileEntityT6SlurryProcessor) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(10), id, playerInventory, new ItemStackHandler(6));
