...
public class ContainerT6SlurryProcessor extends Container {
    ...
    public ContainerT6SlurryProcessor(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	...
    	this((TileEntityT6SlurryProcessor) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(11), id, playerInventory, new ItemStackHandler(6));
    ...
    public ContainerT6SlurryProcessor(@Nullable TileEntityT6SlurryProcessor tile, IIntArray fields, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
        ...
        public boolean mayPickup(PlayerEntity playerIn) {
    		...
    		if(tile.upgradeSlotHandler.getStackInSlot(3).getItem().equals(ModItems.CAPACITY_UPGRADE.get()) && canExtractCapacity() != true) {
	...
	public TileEntityT6SlurryProcessor getTileEntity() {
	...
	public int getInputTank1Capacity() {
		
		return this.fields.get(5);
	}
	
	public int getInputTank2Capacity() {
	...
	public int getOutputTankCapacity() {
		...
		return this.fields.get(9);
	}
	
	public int getInputTank1Stored() {
		
		return this.fields.get(6);
	}
	
	public int getInputTank2Stored() {
